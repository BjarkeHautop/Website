...
If you discover an issue with a package (that you use regularly), why wouldn't you try to reach out to the author? Or instead of using [stargazer](https://CRAN.R-project.org/package=stargazer) consider one of the more modern alternatives,
