...
Just use e.g. [data.table](https://CRAN.R-project.org/package=data.table) (or its tidy-variant [tidytable](https://CRAN.R-project.org/package=tidytable)) and
...
Overall, many of the concerns raised in the post seem to stem from misunderstandings about how R works, or lack of knowledge of the R ecosystem. It might be worthwhile for both the author and readers of the original blog to explore the R ecosystem a bit more deeply, and perhaps even contribute improvements where needed. With that perspective, I hope the post encourages a more constructive dialogue and gives R another look.
